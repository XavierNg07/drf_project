...
def test_remove_movie_incorrect_id(client):
    res = client.delete("/api/movies/99/")
...
@pytest.mark.parametrize(
    ...
    [
        ["add_movie", {}],
        ["add_movie", {"title": "The Big Lebowski", "genre": "comedy"}],
    ],
    indirect=["add_movie"],
)
def test_update_movie_invalid_json(client, add_movie, payload):
